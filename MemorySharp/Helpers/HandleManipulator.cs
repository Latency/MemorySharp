...
public static class HandleManipulator
{
    ...
    public static Process HandleToProcess(SafeMemoryHandle processHandle) => Process.GetProcesses().First(p => p.Id == HandleToProcessId(processHandle));
    ...
    public static int HandleToProcessId(SafeMemoryHandle processHandle)
    {
        ...
        return ret != 0 ? ret : throw new Win32Exception("Couldn't find the process id of the specified handle.");
    }
    ...
    public static int HandleToThreadId(SafeMemoryHandle threadHandle)
    {
        ...
        return ret != 0 ? ret : throw new Win32Exception("Couldn't find the thread id of the specified handle.");
    }

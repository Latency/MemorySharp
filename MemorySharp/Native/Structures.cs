...
public struct Input
{
    ...
    public Input(InputTypes type) : this() => Type = type;
...
public struct M128A
{
    ...
    ///     The low part.
    /// </summary>
    [FieldOffset(M128AMetaData.Offsets.Low)]
    public ulong Low;

    /// <summary>
    ///     The high part.
    /// </summary>
    [FieldOffset(M128AMetaData.Offsets.High)]
    public long High;
}
...
public unsafe struct ThreadContext32
{
    ...
    public ThreadContext32(ThreadContextFlags flags) : this() => ContextFlags = flags;
...
public unsafe struct ThreadContext64
{
    ...
    /// </summary>
    /// <param name="flags">Determines which registers are returned or set during the context query.</param>
    public ThreadContext64(ThreadContextFlags flags) : this() => ContextFlags = flags;
...
public struct Rectangle
{
    ...
    ///     Returns a string that represents the current object.
    /// </summary>
    public override string ToString() => $"Left = {Left} Top = {Top} Height = {Height} Width = {Width}";
}

...
using MemorySharp.Memory.Windows;
...
public class ManagedPeb : RemotePointer
{
    ...
    internal ManagedPeb(MemorySharp memorySharp) : base(memorySharp, FindPeb(memorySharp.Handle)) => _offsets = memorySharp.Is64Process ? Singleton<Peb64Offsets>.Instance : Singleton<Peb32Offsets>.Instance;

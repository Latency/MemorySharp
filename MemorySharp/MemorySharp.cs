...
public class MemorySharp : IDisposable, IEquatable<MemorySharp>
{
    ...
    /// </summary>
    public bool Is64Process { get; init; }

    #endregion Is64Process
    ...
    /// </summary>
    public bool IsRunning => Handle is { IsInvalid: false, IsClosed: false } && !Process.HasExited;
    ...
    /// </summary>
    public ManagedPeb Peb { get; init; }
    ...
    public RemotePointer this[IntPtr address, bool isRelative = true] => new(this, isRelative ? MakeAbsolute(address) : address);
    ...
    public MemorySharp(Process process)
    {
        ...
        Is64Process = ArchitectureDetector.Is64Process(Handle);

        // Initialize the PEB
        Peb = new ManagedPeb(this);
    ...
    /// </summary>
    public override bool Equals(object? obj) => !ReferenceEquals(null, obj) && (ReferenceEquals(this, obj) || (obj.GetType() == GetType() && Equals((MemorySharp)obj)));
    ...
    public IntPtr MakeAbsolute(IntPtr address) =>
        ...
        address.ToInt64() > Modules.MainModule.ModuleMemorySize
                                                      ? throw new ArgumentOutOfRangeException(nameof(address), "The relative address cannot be greater than the main module size.")
                                                      : new IntPtr(Modules.MainModule.BaseAddress.ToInt64() + address.ToInt64()); // Compute the absolute address
    ...
    public IntPtr MakeRelative(IntPtr address) =>
        ...
        address.ToInt64() < Modules.MainModule.BaseAddress.ToInt64()
                                                      ...
                                                      : new IntPtr(address.ToInt64() - Modules.MainModule.BaseAddress.ToInt64()); // Compute the relative address
    ...
    public T Read<T>(IntPtr address, bool isRelative = true) => MarshalType<T>.ByteArrayToObject(ReadBytes(address, MarshalType<T>.Size, isRelative));
    ...
    /// <param name="isRelative">[Optional] State if the address is relative to the main module.</param>
    /// <returns>A value.</returns>
    public T Read<T>(Enum address, bool isRelative = true) => Read<T>(new IntPtr(Convert.ToInt64(address)), isRelative);
    ...
    /// <param name="isRelative">[Optional] State if the address is relative to the main module.</param>
    /// <returns>An array.</returns>
    public T[] Read<T>(Enum address, int count, bool isRelative = true) => Read<T>(new IntPtr(Convert.ToInt64(address)), count, isRelative);
    ...
    protected byte[] ReadBytes(IntPtr address, int count, bool isRelative = true) => MemoryCore.ReadBytes(Handle, isRelative ? MakeAbsolute(address) : address, count);
    ...
    /// </param>
    /// <returns>The string.</returns>
    public string ReadString(Enum address, Encoding encoding, bool isRelative = true, int maxLength = 512) => ReadString(new IntPtr(Convert.ToInt64(address)), encoding, isRelative, maxLength);
    ...
    /// </param>
    /// <returns>The string.</returns>
    public string ReadString(IntPtr address, bool isRelative = true, int maxLength = 512) => ReadString(address, Encoding.UTF8, isRelative, maxLength);
    ...
    /// </param>
    /// <returns>The string.</returns>
    public string ReadString(Enum address, bool isRelative = true, int maxLength = 512) => ReadString(new IntPtr(Convert.ToInt64(address)), isRelative, maxLength);
    ...
    /// <param name="isRelative">[Optional] State if the address is relative to the main module.</param>
    public void Write<T>(IntPtr address, T value, bool isRelative = true) => WriteBytes(address, MarshalType<T>.ObjectToByteArray(value), isRelative);
    ...
    /// <param name="value">The value to write.</param>
    /// <param name="isRelative">[Optional] State if the address is relative to the main module.</param>
    public void Write<T>(Enum address, T value, bool isRelative = true) => Write(new IntPtr(Convert.ToInt64(address)), value, isRelative);
    ...
    /// <param name="array">The array to write.</param>
    /// <param name="isRelative">[Optional] State if the address is relative to the main module.</param>
    public void Write<T>(Enum address, T[] array, bool isRelative = true) => Write(new IntPtr(Convert.ToInt64(address)), array, isRelative);
    ...
    /// <param name="encoding">The encoding used.</param>
    /// <param name="isRelative">[Optional] State if the address is relative to the main module.</param>
    public void WriteString(IntPtr address, string text, Encoding encoding, bool isRelative = true) => WriteBytes(address, encoding.GetBytes($"{text}\0"), isRelative);
    ...
    /// <param name="encoding">The encoding used.</param>
    /// <param name="isRelative">[Optional] State if the address is relative to the main module.</param>
    public void WriteString(Enum address, string text, Encoding encoding, bool isRelative = true) => WriteString(new IntPtr(Convert.ToInt64(address)), text, encoding, isRelative);
    ...
    /// <param name="text">The text to write.</param>
    /// <param name="isRelative">[Optional] State if the address is relative to the main module.</param>
    public void WriteString(IntPtr address, string text, bool isRelative = true) => WriteString(address, text, Encoding.UTF8, isRelative);
    ...
    /// <param name="text">The text to write.</param>
    /// <param name="isRelative">[Optional] State if the address is relative to the main module.</param>
    public void WriteString(Enum address, string text, bool isRelative = true) => WriteString(new IntPtr(Convert.ToInt64(address)), text, isRelative);

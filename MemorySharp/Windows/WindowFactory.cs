...
public class WindowFactory : IFactory
{
    ...
    /// </summary>
    internal IEnumerable<IntPtr> ChildWindowHandles => WindowCore.EnumChildWindows(_memorySharp.Process.MainWindowHandle);
    ...
    /// </summary>
    internal IEnumerable<IntPtr> WindowHandles => new List<IntPtr>(ChildWindowHandles)
    {
        MainWindowHandle
    };

...
public class WindowFactory : IFactory
{
    ...
    /// </summary>
    public IEnumerable<RemoteWindow> ChildWindows => ChildWindowHandles.Select(handle => new RemoteWindow(MemorySharp, handle));

    /// <summary>
    /// Gets all the child window handles that belong to the application.
    /// </summary>
    internal IEnumerable<nint> ChildWindowHandles => WindowCore.EnumChildWindows(MemorySharp.Native.MainWindowHandle);

    /// <summary>
    /// Gets the main window of the application.
    /// </summary>
    public RemoteWindow MainWindow => new(MemorySharp, MainWindowHandle);

    /// <summary>
    /// Gets the main window handle of the application.
    /// </summary>
    public nint MainWindowHandle => MemorySharp.Native.MainWindowHandle;
    ...
    /// </summary>
    public IEnumerable<RemoteWindow> RemoteWindows => WindowHandles.Select(handle => new RemoteWindow(MemorySharp, handle));
    ...
    internal WindowFactory(MemoryManagement.MemorySharp memorySharp) => MemorySharp = memorySharp;

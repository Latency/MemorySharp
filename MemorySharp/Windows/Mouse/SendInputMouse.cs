...
public class SendInputMouse : BaseMouse
{
    ...
    /// </summary>
    private int CalculateAbsoluteCoordinateX(int x) => x * 65536 / NativeMethods.GetSystemMetrics(SystemMetrics.CxScreen);
    ...
    /// </summary>
    private int CalculateAbsoluteCoordinateY(int y) => y * 65536 / NativeMethods.GetSystemMetrics(SystemMetrics.CyScreen);
    ...
    /// </summary>
    private Input CreateInput() => new(InputTypes.Mouse);

// ****************************************************************************
// Project:  MemorySharp
// File:     MicrosoftThiscallCallingConvention.cs
...
///     The first parameter must be a pointer of the instance of the class. Internally, the 'this' pointer is stored in
///     ECX.
/// </summary>
/// <remarks>
...
/// </remarks>
internal class MicrosoftThiscallCallingConvention : ICallingConvention
{
    /// <summary>
    ...
    public void FormatCall(IntPtr function, IntPtr[] parameters, List<string> instructions)
    {
        ...
        instructions.AddRange(parameters.Skip(1).Reverse().Select(parameter => $"push {parameter}"));

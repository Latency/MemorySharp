...
public class MemoryProtection : IDisposable
{
    ...
    public MemoryProtection(MemorySharp memorySharp, IntPtr baseAddress, long size, MemoryProtectionFlags protection = MemoryProtectionFlags.ExecuteReadWrite, bool mustBeDisposed = true) : this(memorySharp, baseAddress, new IntPtr(size), protection, mustBeDisposed)
    { }
    ...
    /// <param name="protection">The new protection to apply.</param>
    /// <param name="mustBeDisposed">The resource will be automatically disposed when the finalizer collects the object.</param>
    public MemoryProtection(MemorySharp memorySharp, IntPtr baseAddress, IntPtr size, MemoryProtectionFlags protection = MemoryProtectionFlags.ExecuteReadWrite, bool mustBeDisposed = true)
    {
        // Save the parameters

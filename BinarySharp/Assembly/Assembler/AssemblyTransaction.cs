...
public class AssemblyTransaction : IDisposable
{
    ...
    public void AddLine(string asm, params object[] args) => Mnemonics.AppendLine(string.Format(asm, args));
    ...
    public byte[] Assemble() => MemorySharp.Assembly.Assembler.Assemble(Mnemonics.ToString());
    ...
    /// </summary>
    public void Clear() => Mnemonics.Clear();
    ...
    /// <param name="asm">A composite format string.</param>
    /// <param name="args">An object array that contains zero or more objects to format.</param>
    public void InsertLine(int index, string asm, params object[] args) => Mnemonics.Insert(index, string.Format(asm, args));

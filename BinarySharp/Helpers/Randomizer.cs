...
public static class Randomizer
{
    ...
    public static int GenerateNumber(int minValue, int maxValue) => Random.Next(minValue, maxValue);
    ...
    public static int GenerateNumber(int maxValue) => Random.Next(maxValue);
